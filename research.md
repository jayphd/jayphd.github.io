...
<p> The North Indian Ocean (NIO), including the Arabian Sea and Bay of Bengal, is one of the warmest regions of the global ocean during the premonsoon months. In May-June 2024, I participated in a research cruise to better understand air-sea interactions over the Bay of Bengal during the warming phase. Understanding the warming and cooling of the NIO is crucial for protecting marine ecosystems, e.g., identifying Marine Protected Areas (MPA), and for monsoon forecasting. My particular interest is to understand the impact of atmospheric processes on ocean warming. Investigation of the observations from the Indian peninsula and the Bay shows that land-atmosphere interactions during continental heatwaves lead to a strong inversion (a rapid increase in temperature and dryness with height) over the Bay (Phadtare et al., in prep). This suppresses cloud cover and allows more solar radiation to reach the ocean surface, thereby warming the ocean. It leads to a compound heatwave over the region, with both land and ocean experiencing extreme heat.</p> <br>
